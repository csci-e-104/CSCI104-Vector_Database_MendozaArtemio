...
![Face Neet Architecture](./images/deep-learning-architecture.png)
...
![Milvus Standalone Architecture](./images/milvus_standalone_architecture.jpg)


The image above is a high level schema of the Milvus Standalone architecture

Now that we stablished the real motivations behind this project, lets get to the official documentation.
